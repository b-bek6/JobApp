...
export default function Home1(){
    return(<>
        <div className="bg-[#f3ecec] p-7 justify-center align-middle flex">
                <div className="">
                    <Image src={Bulb} />
                </div>
                <div className="align-middle grid gap-3 p-3">
                    ...
                    <button className="bg-secondary text-white p-2 w-40">Shop Now</button>
