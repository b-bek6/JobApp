...
const { fetchJobs, storeJobs, updateJobs, removeJobs, fetchSingleJobs, fetchEmployerJobs, applicant } = require('../controller/jobs');
...
router.get("/employer/:id" ,checkAuthentication, isEmployer, applicant);
